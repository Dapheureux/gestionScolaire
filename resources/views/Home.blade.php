...
<body class="bg-gray-100 font-sans flex">
  ...
  <aside class="bg-blue-800 text-white w-1/5 p-4 shadow-md min-h-screen">
    ...
    <ul>
      <li class="mb-2 flex p-3 border rounded-lg">
        ...
        <a href="#" class="hover:text-gray-300">Référentiel</a>
      </li>
      <li class="mb-2 flex p-3 border rounded-lg">
  ...
  <div class="w-4/5 p-8">
    <!-- Navbar -->
    <nav class="bg-blue-700 p-4 text-white mb-8 shadow-md">
      <div class="container mx-auto">
        <h1 class="text-3xl font-bold flex justify-center">
          Gestion Scolaire
        </h1>
      </div>
    </nav>
    ...
    <div class="bg-white p-6 rounded-md shadow-md">
      <h2 class="text-2xl font-semibold mb-4">Contenu de la Section</h2>
      <!-- Informations supplémentaires -->
      <div class="mt-8 flex justify-between">
        <div class="flex-1 bg-blue-200 p-4 rounded-md shadow-md">
          <h3 class="text-lg font-semibold mb-2">Nombre total d'élèves</h3>
          <p class="text-xl font-bold">350</p>
        </div>
        <div class="flex-1 bg-green-200 p-4 rounded-md shadow-md mx-4">
          <h3 class="text-lg font-semibold mb-2">
            Nombre total d'enseignants
          </h3>
          <p class="text-xl font-bold">25</p>
        </div>
        <div class="flex-1 bg-yellow-200 p-4 rounded-md shadow-md">
          <h3 class="text-lg font-semibold mb-2">
            Somme totale des paiements
          </h3>
          <p class="text-xl font-bold">20,000 FCFA</p>
        </div>
      </div>
    </div>
  </div>
