...
<head>
    ...
    <title>Modification d'un eleve</title>
</head>
...
<body class="bg-gray-100 font-sans flex">
    ...
    <div class="w-4/5 p-10 bg-gray-100 h-screen">
        ...
        <form action="{{ route('eleves.update', $eleve->id) }}" method="post">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="matricule" id="matricule" class="border rounded-md px-3 py-2 w-full"  value="{{ $eleve->matricule }}" required>
                </div>
                <div class="mb-4">
                    <label for="nom" class="block text-sm font-semibold text-gray-600">Nom de l'élève</label>
                    <input type="text" name="nom" id="nom" class="border rounded-md px-3 py-2 w-full"  value="{{ $eleve->nom }}" required>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    <label for="prenom" class="block text-sm font-semibold text-gray-600">Prénom de l'élève</label>
                    <input type="text" name="prenom" id="prenom" class="border rounded-md px-3 py-2 w-full"  value="{{ $eleve->prenom }}" required>
                </div>

                <div class="mb-4">
                    <label for="date_naissance" class="block text-sm font-semibold text-gray-600">date de naissance</label>
                    <input type="date" name="date_naissance" id="date_naissance" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->date_naissance }}" required>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    <label for="lieu_naissance" class="block text-sm font-semibold text-gray-600">Lieu de naissance</label>
                    <input type="text" name="lieu_naissance" id="lieu_naissance" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->lieu_naissance }}" required>
                </div>
                <div class="mb-4">
                    <label for="adresse" class="block text-sm font-semibold text-gray-600">Adresse</label>
                    <input type="text" name="adresse" id="adresse" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->adresse }}" required>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    <label for="telephone" class="block text-sm font-semibold text-gray-600">Telephone</label>
                    <input type="text" name="telephone" id="telephone" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->telephone }}" required>
                </div>
                <div class="mb-4">
                    <label for="sexe" class="block text-sm font-semibold text-gray-600">Sexe</label>
                    <select name="sexe" id="sexe" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->sexe }}" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->email }}" required>
                </div>
                <div class="mb-4">
                    <label for="nationalite" class="block text-sm font-semibold text-gray-600">Nationalite</label>
                    <input type="text" name="nationalite" id="nationalite" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->nationalite }}" required>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="classe_id" id="classe_id" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->classe_id }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="employe_id" id="employe_id" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->employe_id }}">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="photo" id="photo" class="border rounded-md px-3 py-2 w-full" value="{{ $eleve->photo }}">
            </div>
